...
class PortValidator(_Validator):
	...
	def __init__(self, low_port=0, high_port=65536, accept_none=False):
		self._low_port = low_port
		self._high_port = high_port
		super(PortValidator, self).__init__(accept_none=accept_none)
	...
	def __call__(self, value):
		...
		if self._low_port > value > self._high_port:
